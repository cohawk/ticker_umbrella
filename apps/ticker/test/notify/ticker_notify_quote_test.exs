defmodule Ticker.Notify.Quote.Test do
  ...
  test "notify quote" do
    Application.put_env(
      :ticker,
      :quote_notify,
      [notify_module: Ticker.Notify.Quote.Test, notify_fn: :notify_quote_test_callback],
      persistent: true
    )
  ...
  test "notify quote -- no module configured" do
    Application.put_env(
      :ticker,
      :quote_notify,
      [notify_module: nil, notify_fn: :notify_quote_test_callback],
      persistent: true
    )
  ...
  test "notify quote -- no callback configured" do
    Application.put_env(
      :ticker,
      :quote_notify,
      [notify_module: Ticker.Notify.Quote.Test, notify_fn: nil],
      persistent: true
    )
