defmodule Ticker.Quote.Processor.HTTP.Test do
  ...
  @good_body_200 {:ok,
                  [
                    %Ticker.Quote{
                      symbol: "GOOG",
                      marketPercent: 0.03406,
                      bidSize: 0,
                      bidPrice: 0,
                      askSize: 200,
                      askPrice: 983.98,
                      volume: 27292,
                      lastSalePrice: 983.56,
                      lastSaleSize: 50,
                      lastSaleTime: 1_496_683_852_096,
                      lastUpdated: 1_496_683_920_111
                    },
                    %Ticker.Quote{
                      symbol: "TSLA",
                      marketPercent: 0.01556,
                      bidSize: 100,
                      bidPrice: 344.4,
                      askSize: 0,
                      askPrice: 0,
                      volume: 63888,
                      lastSalePrice: 344.38,
                      lastSaleSize: 100,
                      lastSaleTime: 1_496_683_923_830,
                      lastUpdated: 1_496_683_926_824
                    }
                  ]}
  ...
  def good_200 do
    {:ok,
     %HTTPoison.Response{
       body:
         ~s([{"symbol":"GOOG","marketPercent":0.03406,"bidSize":0,"bidPrice":0,"askSize":200,"askPrice":983.98,"volume":27292,"lastSalePrice":983.56,"lastSaleSize":50,"lastSaleTime":1496683852096,"lastUpdated":1496683920111},
       ...
       headers: [
         ...
         {"Content-Security-Policy",
          "default-src 'self'; child-src 'none'; object-src 'none'; style-src 'self' 'unsafe-inline'; font-src data:; connect-src 'self' https://auth.iextrading.com wss://iextrading.com wss://tops.iextrading.com; script-src 'self';"},
  ...
  def bad_400 do
    {:ok,
     %HTTPoison.Response{
       body:
         ~s({"error": "child \"symbols\" fails because [\"symbols\" is not allowed to be empty]"}"),
       headers: [
         {"Server", "nginx"},
